...
//   - For everything else (editorial blog scrapes, museum, Foursquare),
//     pass `lat,lng`. Coordinates beat text search every time; the user
//     already saw the venue name on the card.
